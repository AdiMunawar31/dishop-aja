					...
					<div className='grid grid-cols-12'>
						...
						<div className='w-full col-span-8 text-gray-700 md:text-center text-2xl font-semibold'>
							...
							<p className='text-xs text-white font-light mt-2 text-start ml-6'>
								Colgate SALE 55% OFF | Air Jordan SALE 45% OFF | Sony SPECIAL PROMO | CLEARANCE SALE Nutty Nuts | PROMO
								Fashion Pria
							</p>
						</div>
						<div className='col-span-3 flex items-center justify-center'>
							<Link to='/cart'>
								<button className='relative focus:outline-none text-white mx-4 sm:mx-0'>
									<span className='absolute -top-2 -right-2 w-5 bg-red-500 text-xs rounded-full px-1 py-0.5'>9</span>
									<AiOutlineShoppingCart className='text-2xl text-white' />
								</button>
							</Link>
							<div className='mx-6 h-12 border-r border-white'></div>
