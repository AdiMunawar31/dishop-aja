              ...
              <div className="my-4">
                <form id="footerForm" action="/subscribe/" method="POST" className="form-horizontal">
                  <input
                    ...
                    required="required"
                  />
                  <button type="button" className="bg-blue-500 rounded-md ml-1 text-white active:bg-blue-400 shadow hover:shadow-lg outline-none focus:outline-none h-auto text-xs py-3.5 px-4">
                    Submit
                  </button>
                </form>
              </div>
